    ...
    public class DataGridViewPrinter
    {
        ...
        public static void Print_DataGridView(DataGridView dgv1)
        {
	        ...
	        {	
                ...
                RowsPerPage = 0;
                printDoc.DefaultPageSettings.Margins = new Margins(0, 35, 60, 0);
                //printDoc.DefaultPageSettings.PaperSize=new PaperSize("A4"
                ...
                while (RowPos <= dgv.Rows.Count - 1)
                {
                    ...
                    else
                    {
                        if (NewPage)
                        {
                            ...
                            //liyafei 
                            e.Graphics.DrawString(PrintTitle, new Font("宋体", 24, FontStyle.Bold),
                                    Brushes.Black, e.MarginBounds.Left + 325, e.MarginBounds.Top +10-
                            e.Graphics.MeasureString(PrintTitle, new Font("宋体", 24,
                        ...
                        {
                            if (Cel.ContentBounds.Height > GridRow.Height)
                            {
                                CellHeight = Cel.ContentBounds.Height;
                            }
                            else
                            {
                                CellHeight = GridRow.Height;
