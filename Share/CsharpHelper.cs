...
namespace DEVGIS.CsharpLibs
{
    public class CsharpHelper
    {
        ...
        /// </summary>
        /// <param name="extension">File type such as .doc</param>
        /// <param name="title">Title </param>
        /// <param name="extensionDescription">File extension description, Such as A word file</param>
        public void RegistDefaultApp(string extension,string title ,string extensionDescription)
        {
